    ...
    <?php
        ...
        while (list($id, $name, $email,$phone, $date, $time, $person) = mysqli_fetch_array($val)) {
            echo "<tr>
                ...
                <td> $time </td>
                <td> $person </td>
                <td> <a href='reservation-edit.php?id=$id'><button type='button' class='btn btn-warning'> Edit </button></a> </td>
                <td> <a href='reservation-delete.php?id=$id' onclick=\"return confirm('Are you sure you want to delete this item?');\"><button type='button' class='btn btn-danger'> Delete </button></a> </td>
                </tr>";
            }
        } else {
