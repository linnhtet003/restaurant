    ...
    <?php
        ...
        while (list($id, $name, $email,$about, $review) = mysqli_fetch_array($val)) {
            echo "<tr>
                ...
                <td> $about </td>
                <td> $review </td>
                <td> <a href='review-delete.php?id=$id' onclick=\"return confirm('Are you sure you want to delete this item?');\"><button type='button' class='btn btn-danger'> Delete </button></a> </td>
                </tr>";
            }
        } else {
