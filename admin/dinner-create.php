                        ...
                        <div class="page-header float-right">
                            <div class="page-title">
                                <ol class="breadcrumb text-right">
                                    ...
                                    <li class="active">Dinner Create</li>
                                </ol>
                            </div>
                        </div>
                    </div>
...
<?php
    ...
    if(isset($_POST['submit'])) {
        ...
        $query = mysqli_query($con, "insert into dinner(name, description, price, img) value('$name', '$description', '$price', '$image')");
        if($query) {
            move_uploaded_file($_FILES["image"]["tmp_name"],"dinner/".$image);
            echo "<script>alert('Dinner product has been added.');</script>";
                            ...
                            <div class="card-body card-block">
                                <form method="POST" enctype="multipart/form-data" class="form-horizontal">
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-12 col-md-9"><input type="text" id="text-input" name="name" placeholder="Dinner Name" class="form-control" required></div>
                                    </div>

                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="text-input" class=" form-control-label"> Dinner Price</label></div>
                                        <div class="col-12 col-md-9"><input type="text" id="text-input" name="price" placeholder="Dinner Price" class="form-control" required></div>
                                    </div>

                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="textarea-input" class=" form-control-label">Dinner Description</label></div>
                                        <div class="col-12 col-md-9"><textarea name="description" id="textarea-input" rows="5" placeholder="Dinner Descriptions" class="form-control" required></textarea></div>
                                    </div>
