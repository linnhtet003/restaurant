                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header">
                                <strong class="card-title">Drinks List</strong>
                            </div>
                            <div class="card-body">
                                <table class="table">
    ...
    <?php
        ...
        while (list($id, $name, $description,$price, $image) = mysqli_fetch_array($val)) {
            echo "<tr>
                ...
                <td> $description </td>
                <td> $price </td>
                <td> <img src='./drink/$image' height='100' width='100' style='border-radius: 20px;' /> </td>
                <td> <a href='drink-edit.php?id=$id'><button type='button' class='btn btn-warning'> Edit </button></a> </td>
                <td> <a href='drink-delete.php?id=$id&img=$image' onclick=\"return confirm('Are you sure you want to delete this item?');\"><button type='button' class='btn btn-danger'> Delete </button></a> </td>
                </tr>";
            }
        } else {
