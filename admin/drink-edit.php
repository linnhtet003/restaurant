                ...
                <div class="col-lg-12">
                        <div class="card">
                            <div class="text-center card-header">
                                <strong>Drink</strong> Edit
                            </div>
<?php
     error_reporting(1);
     include('connection.php');
     $id = $_GET['id'];
     $val = $con->query("Select * from drinks where id=$id");
     ...
     if(isset($_POST['submit'])) {
        ...
        $con->query("update drinks set name='$new_name', description='$new_description', price='$new_price' where id=$id ");
                            ...
                            <div class="card-body card-block">
                                <form method="POST" enctype="multipart/form-data" class="form-horizontal">
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-12 col-md-9"><input type="text" id="text-input" name="name" placeholder="Drink Name" value="<?php echo $data['name'] ?>" class="form-control" required></div>
                                    </div>

                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="text-input" class=" form-control-label"> Drink Price</label></div>
                                        <div class="col-12 col-md-9"><input type="text" id="text-input" name="price" placeholder="Drink Price" value="<?php echo $data['price'] ?>" class="form-control" required></div>
                                    </div>

                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="textarea-input" class=" form-control-label">Drink Description</label></div>
                                        <div class="col-12 col-md-9"><textarea name="description" id="textarea-input" rows="5" placeholder="Drink Descriptions" class="form-control" required><?php echo $data['description'] ?></textarea></div>
                                    </div>
