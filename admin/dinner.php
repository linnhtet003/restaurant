                        ...
                        <div class="page-header float-right">
                            <div class="page-title">
                                <ol class="breadcrumb text-right">
                                    ...
                                    <li class="active">Dinner List</li>
                                </ol>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header">
                                <strong class="card-title">Dinner List</strong>
                            </div>
                            <div class="card-body">
                                <table class="table">
    ...
    <?php
        ...
        while (list($id, $name, $description,$price, $image) = mysqli_fetch_array($val)) {
            echo "<tr>
                ...
                <td> <a href='dinner-edit.php?id=$id'><button type='button' class='btn btn-warning'> Edit </button></a> </td>
                <td> <a href='dinner-delete.php?id=$id&img=$image' onclick=\"return confirm('Are you sure you want to delete this item?');\"><button type='button' class='btn btn-danger'> Delete </button></a> </td>
                </tr>";
            }
        } else {
