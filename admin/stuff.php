                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header">
                                <strong class="card-title">Stuff List</strong>
                            </div>
                                ...
                                <table class="table ">
                                    <thead>
                                        <tr>
                                            ...
                                            <th>Name</th>
                                            <th>Position</th>
                                            <th class="serial" style="text-align:left;" colspan="2" scope="col">Action</th>
                                        </tr>
                                    </thead>
                                    <tbody>
    ...
    <?php
        ...
        while (list($id, $name, $position, $image) = mysqli_fetch_array($val)) {
            echo "<tr>
                ...
                <div class='round-img'>
                <td> <img class='rounded-circle' src='./stuff/$image' alt='$name' /> </td> </div>
                <td> <span class='name'> $name </span> </td>
                <td> <span class='product'> $position </span> </td>
                <td> <a style='margin-right: -100px;' href='stuff-edit.php?id=$id'><button type='button' class='btn btn-warning'> Edit </button></a> </td>
                <td> <a style='margin-left: -100px;' href='stuff-delete.php?id=$id&image=$image' onclick=\"return confirm('Are you sure you want to delete this item?');\"><button type='button' class='btn btn-danger'> Delete </button></a> </td>
                </tr>";
            }
        } else {
