...
<body>
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header">
                                <strong class="card-title">Lunch List</strong>
                            </div>
                            <div class="card-body">
                                <table class="table">
    ...
    <?php
        ...
        $data = "SELECT * FROM lunch ORDER by id DESC";
        $val = $con->query($data);
        $i = 1;
        if ($val->num_rows > 0) {
        while (list($id, $name, $description,$price, $image) = mysqli_fetch_array($val)) {
            echo "<tr>
                ...
                <td> $description </td>
                <td> $price </td>
                <td> <img src='./lunch/$image' height='100' width='100' style='border-radius: 20px;' /> </td>
                <td> <a href='lunch-edit.php?id=$id'><button type='button' class='btn btn-warning'> Edit </button></a> </td>
                <td> <a href='lunch-delete.php?id=$id&img=$image' onclick=\"return confirm('Are you sure you want to delete this item?');\"><button type='button' class='btn btn-danger'> Delete </button></a> </td>
                </tr>";
            }
        } else {
